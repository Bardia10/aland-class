...
import sty from "./PlasmicAsignmentWindow.module.css"; // plasmic-import: PW9NSerIwXDt/css
  ...
  return (
    ...
    >
      {(_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
        ...
        return (
          <div
            className={classNames(projectcss.all, sty.freeBox__uWy0S)}
            key={currentIndex}
          >
            <div
              className={classNames(
            ...
            >
              <div
                className={classNames(projectcss.all, sty.freeBox__wqjSv, {
                  [sty.freeBoxdontShowMore__wqjSvswHm1]: hasVariant(
                    $state,
                    "dontShowMore",
                    "dontShowMore"
                  )
