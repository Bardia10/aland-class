...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: 1vQbW38zFUM6/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: WxMsiRgxqwT7/css
  ...
  return (
    <BaseDialogTrigger
      ...
      dialog={
        ...
        >
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <div className={classNames(projectcss.all, sty.freeBox__v7Xur)}>
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button2
            className={classNames("__wab_instance", sty.button2__jk77)}
            label={"Open Popover"}
          />
        ),
