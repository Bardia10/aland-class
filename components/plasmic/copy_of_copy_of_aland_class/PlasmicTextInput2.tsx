...
import sty from "./PlasmicTextInput2.module.css"; // plasmic-import: GT3YqJyjSoJG/css
...
function PlasmicTextInput2__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__zMbXt, {
          [sty.freeBoxediting__zMbXtGure9]: hasVariant(
            $state,
            "editing",
            "editing"
          )
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__ymYk, {
          [sty.freeBoxediting__ymYkgure9]: hasVariant(
            $state,
            "editing",
            "editing"
          )
