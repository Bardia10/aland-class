...
import Label from "../../Label"; // plasmic-import: cE9W8VGUfxT_/component
import TextInput3 from "../../TextInput3"; // plasmic-import: 6rhJETjUSOTO/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: KHcWHBdYac_z/component
import Description from "../../Description"; // plasmic-import: nXrdGn-UefeK/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: CbmnV1OXyZ72/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__sGvsU, {
          [sty.freeBoxiconEnd__sGvsUrBcD8]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__sGvsUsPfIc]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__sGvsUGh6W]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__f22Gb, {
            [sty.freeBoxiconStart__f22GbsPfIc]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__f22GbGh6W]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__xVc2R)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox___7Yl9W, {
            [sty.freeBoxiconEnd___7Yl9WrBcD8]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart___7Yl9WsPfIc]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__uJgg3)}
                role={"img"}
              />
            ),
