...
import MenuPopover from "../../MenuPopover"; // plasmic-import: 8II9yLaW_YzO/component
import MenuItem from "../../MenuItem"; // plasmic-import: zRgyuNvkAa82/component
import MenuSection from "../../MenuSection"; // plasmic-import: 4HkwR4_opXh_/component
...
import sty from "./PlasmicCombobox.module.css"; // plasmic-import: 4VLCeQmYF0lF/css
...
function PlasmicCombobox__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div className={classNames(projectcss.all, sty.freeBox__zmTnk)}>
        {(() => {
          const child$Props = {
        ...
        >
          <div className={classNames(projectcss.all, sty.freeBox__hOiMh)}>
            <ChevronDownIcon
