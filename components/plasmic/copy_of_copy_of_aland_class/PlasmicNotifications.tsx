...
import NotificationsChat from "../../NotificationsChat"; // plasmic-import: -dz9eTlPfUTl/component
...
import sty from "./PlasmicNotifications.module.css"; // plasmic-import: Nj5CZ4TEJ72v/css

import MessageSvgrepoComSvgIcon from "./icons/PlasmicIcon__MessageSvgrepoComSvg"; // plasmic-import: GbzZy2GWihXq/icon
...
function PlasmicNotifications__RenderFunc(props: {
  ...
  return (
    <AntdModal
      ...
      hideFooter={true}
      modalContentClassName={classNames({ [sty["pcls_d8zni-74oNgZ"]]: true })}
      ...
      trigger={
        <div className={classNames(projectcss.all, sty.freeBox__pxodo)}>
          ...
          {(() => {
            ...
            <div className={classNames(projectcss.all, sty.freeBox__bhyty)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
      ...
      width={"600px"}
      wrapClassName={classNames({ [sty["pcls_y0WIj44gzzhn"]]: true })}
    >
      <div className={classNames(projectcss.all, sty.freeBox__oupCg)}>
        <NotificationsChat
