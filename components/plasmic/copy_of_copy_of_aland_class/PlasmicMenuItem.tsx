...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: zRgyuNvkAa82/css
...
function PlasmicMenuItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__oao1H)}>
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__uo1Sg)}>
            <div
              className={classNames(
                projectcss.all,
