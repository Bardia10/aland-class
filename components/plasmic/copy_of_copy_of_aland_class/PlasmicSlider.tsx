...
import SliderThumb from "../../SliderThumb"; // plasmic-import: ZeTXWHltN_Xs/component
...
import sty from "./PlasmicSlider.module.css"; // plasmic-import: A80TObPsNRQ6/css
  ...
  return (
    ...
    >
      {$props.showLabel || $props.showOutputText ? (
        <div className={classNames(projectcss.all, sty.freeBox__xiWc7)}>
          {$props.showLabel ? (
            <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__aVde7)}>
        <div
        ...
        >
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <SliderThumb
                  className={classNames("__wab_instance", sty.sliderThumb__y6E)}
                />
              ),
