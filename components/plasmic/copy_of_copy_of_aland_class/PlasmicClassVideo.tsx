...
import sty from "./PlasmicClassVideo.module.css"; // plasmic-import: a1yl-MATwwH4/css
  ...
  return (
    ...
    >
      {(_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
        ...
        return (
          <div
            className={classNames(projectcss.all, sty.freeBox__kfkc5)}
            key={currentIndex}
          >
            <div
              className={classNames(
            ...
            <PlasmicImg__
              alt={""}
              className={classNames(sty.img__jcxf8)}
              displayHeight={"400px"}
            ...
            <div className={classNames(projectcss.all, sty.freeBox__kyQ2C)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__wjCq)}>
                <div
                  className={classNames(
                    projectcss.all,
                    projectcss.__wab_text,
                ...
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__qLva2)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
                  ...
                  loading={"lazy"}
                  src={{
                    src: "/plasmic/copy_of_copy_of_aland_class/images/download1Jpg.jpg",
                    fullWidth: 160,
                    fullHeight: 160,
                    aspectRatio: undefined
                  }}
            ...
            <div className={classNames(projectcss.all, sty.freeBox__rEYqO)}>
              <div className={classNames(projectcss.all, sty.freeBox__aWObX)}>
                <div
                  className={classNames(
                    projectcss.all,
                    projectcss.__wab_text,
                    sty.text__dn3Cw,
                    {
                      [sty.textshowFiles2__dn3CwzvqUt]: hasVariant(
                        $state,
                        "showFiles2",
                        "showFiles2"
                      )
                ...
                <div
                  className={classNames(
                    ...
                    sty.text__xx2Zz,
                    {
                      [sty.textshowFiles2__xx2ZzzvqUt]: hasVariant(
                        $state,
                        "showFiles2",
                        "showFiles2"
                      )
