...
import sty from "./PlasmicSelect2.module.css"; // plasmic-import: k8I-r2mqIPY8/css
        ...
        menuItems={renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <MenuSection
                className={classNames("__wab_instance", sty.menuSection__kaKLj)}
                header={
                  <div
                    className={classNames(
                      projectcss.all,
