...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: WHi0h0k6i9ll/css
...
function PlasmicRangeSlider__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox___3VpFh)}>
        {$props.showLabel ? (
          <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__ym7Kn)}>
        <div
