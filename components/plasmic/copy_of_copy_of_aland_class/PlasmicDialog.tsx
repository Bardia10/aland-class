...
import sty from "./PlasmicDialog.module.css"; // plasmic-import: 5e4CktAHvQep/css
...
function PlasmicDialog__RenderFunc(props: {
  ...
  return (
    <Dialog
      ...
      overlayClassName={classNames({ [sty["pcls_j_21fDuqnfbH"]]: true })}
      ...
      triggerSlot={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__s1YF3)}
                >
                  {"Show dialog"}
                </Button>
              ),
    ...
    >
      ...
      >
        ...
        >
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <div className={classNames(projectcss.all, sty.freeBox__nFkwa)}>
                <div
                  className={classNames(
                    projectcss.all,
