...
import sty from "./PlasmicCtaBlock.module.css"; // plasmic-import: JJjSYreY6nt-/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column___4Zorl)}>
            <h2
          ...
          <div className={classNames(projectcss.all, sty.column___0J1Vy)}>
            <Button
