...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: tJYzp7E7H0MW/component
import Select__Option from "../../Select__Option"; // plasmic-import: j73jVBp6b0B7/component
import Select__OptionGroup from "../../Select__OptionGroup"; // plasmic-import: m2_CPv6IQLFz/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: uO0H7emf5cyh/css
...
export type PlasmicSelect__VariantsArgs = {
  ...
  color?: SingleChoiceArg<
    ...
    | "clear"
  >;
  grid?: SingleBooleanChoiceArg<"grid">;
};
  ...
  const stateSpecs: Parameters<typeof useDollarState>[0] = React.useMemo(
    () => [
      ...
      },
      {
        ...
        type: "private",
        variableType: "variant",
        initFunc: ({ $props, $state, $queries, $ctx }) => $props.grid
      }
    ],
    [$props, $ctx, $refs]
  );
        ...
        <button
          ...
          className={classNames(
            ...
            sty.trigger,
            {
              ...
              [sty.triggergrid]: hasVariant($state, "grid", "grid"),
          ...
          >
            <div
              ...
              className={classNames(projectcss.all, sty.optionsContainer, {
                [sty.optionsContainergrid]: hasVariant($state, "grid", "grid"),
                [sty.optionsContainerisOpen]: hasVariant(
                  $state,
                  "isOpen",
                  "isOpen"
                ),
                [sty.optionsContainerisOpen_grid]:
                  hasVariant($state, "isOpen", "isOpen") &&
                  hasVariant($state, "grid", "grid")
              })}
            >
    ...
    if (!("children" in props)) {
      props = {
        ...
        children: (
          <React.Fragment>
            <Select__Option
              className={classNames("__wab_instance", sty.option___814Bb)}
              value={"value1"}
            >
              {"Option 1"}
            </Select__Option>
            <Select__Option
              className={classNames("__wab_instance", sty.option__ss8C0)}
              value={"value2"}
            >
              {"Option 2"}
            </Select__Option>
