...
import sty from "./PlasmicProfileSetting.module.css"; // plasmic-import: yITFjBWRumHx/css

import EditSvgrepoComSvgIcon from "./icons/PlasmicIcon__EditSvgrepoComSvg"; // plasmic-import: qRp1WhymMpuN/icon
...
function PlasmicProfileSetting__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <div className={classNames(projectcss.all, sty.freeBox__fW7Tv)}>
          {(() => {
            try {
            ...
            <div className={classNames(projectcss.all, sty.freeBox__ybs9A)}>
              <EditSvgrepoComSvgIcon
                className={classNames(projectcss.all, sty.svg__d9OAx)}
                onClick={async event => {
                  const $steps = {};
          ...
          {(() => {
            ...
            <div className={classNames(projectcss.all, sty.freeBox__tqoLz)}>
              <Button
                className={classNames("__wab_instance", sty.button__esiMk)}
                color={"green"}
                onClick={async event => {
                  const $steps = {};
      ...
      >
        <div className={classNames(projectcss.all, sty.freeBox__gh6FB)}>
          {(() => {
            try {
            ...
            <div className={classNames(projectcss.all, sty.freeBox__v1Li2)}>
              <EditSvgrepoComSvgIcon
                className={classNames(projectcss.all, sty.svg__iRfI)}
                onClick={async event => {
                  const $steps = {};
          ...
          {(() => {
            ...
            <div className={classNames(projectcss.all, sty.freeBox___3BxTm)}>
              <Button
                className={classNames("__wab_instance", sty.button__sQcwW)}
                color={"green"}
                onClick={async event => {
                  const $steps = {};
      ...
      >
        <div className={classNames(projectcss.all, sty.freeBox__dw6Mf)}>
          {(() => {
            try {
            ...
            <div className={classNames(projectcss.all, sty.freeBox__ct1OW)}>
              <EditSvgrepoComSvgIcon
                className={classNames(projectcss.all, sty.svg__c8Tms)}
                onClick={async event => {
                  const $steps = {};
          ...
          {(() => {
            ...
            <div className={classNames(projectcss.all, sty.freeBox__rjL6A)}>
              <Button
                className={classNames("__wab_instance", sty.button___3CRrU)}
                color={"green"}
                onClick={async event => {
                  const $steps = {};
      ...
      {(() => {
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__fqxLq)}
          onClick={async event => {
            const $steps = {};
