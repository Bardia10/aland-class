...
import Button2 from "../../Button2"; // plasmic-import: 6EVQCHUb4ELF/component
...
import sty from "./PlasmicDrawer2.module.css"; // plasmic-import: 9SjXfM6GQCDO/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls__JFw7FOOkX9r"]]: true })}
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox___41Cms)}>
              {$props.showHeading ? (
                <BaseHeading
              ...
              >
                {renderPlasmicSlot({
                  defaultContents: (
                    <div
                      className={classNames(projectcss.all, sty.freeBox__qfFv1)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__smcv)}>
                {renderPlasmicSlot({
                  defaultContents: (
                    <div
                      className={classNames(projectcss.all, sty.freeBox__boHL)}
                    >
                      <Button2
                        color={"muted"}
                        label={"Close"}
      ...
      trigger={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button2
                  className={classNames("__wab_instance", sty.button2__sJbTw)}
                  label={
                    <div
                      className={classNames(
                        projectcss.all,
