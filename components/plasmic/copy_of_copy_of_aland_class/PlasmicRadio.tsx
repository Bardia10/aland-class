...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: l2s9DfJ5Ts0v/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__wznj4)}>
        <div className={classNames(projectcss.all, sty.freeBox__pVxVs)} />
      </div>
      {renderPlasmicSlot({
