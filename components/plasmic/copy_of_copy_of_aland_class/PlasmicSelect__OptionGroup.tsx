...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: m2_CPv6IQLFz/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: uO0H7emf5cyh/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__zbpVh)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__sk4RL)}
              />
            </React.Fragment>
          ),
          value: args.children
