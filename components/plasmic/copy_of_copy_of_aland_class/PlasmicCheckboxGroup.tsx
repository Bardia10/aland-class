...
import Checkbox2 from "../../Checkbox2"; // plasmic-import: sV21mt0KzCc_/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: QGhGYNaZNLFQ/css
...
function PlasmicCheckboxGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__cUlPx)}>
            <Checkbox2
              className={classNames("__wab_instance", sty.checkbox2__yJa4S)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox2
              className={classNames("__wab_instance", sty.checkbox2__eL6D)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox2
              className={classNames("__wab_instance", sty.checkbox2__uzgdK)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
