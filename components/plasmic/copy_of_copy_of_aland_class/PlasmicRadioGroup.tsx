...
import Radio from "../../Radio"; // plasmic-import: l2s9DfJ5Ts0v/component
...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: 40rroiKGU4jp/css
...
function PlasmicRadioGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__hoeXt)}>
            <Radio
              className={classNames("__wab_instance", sty.radio__kp8N)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__kcycl)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__ufHk8)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
