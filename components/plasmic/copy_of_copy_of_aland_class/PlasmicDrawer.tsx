...
import sty from "./PlasmicDrawer.module.css"; // plasmic-import: TSVyqa1vedzV/css

import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: ep15jNBOwX87/icon
import Icon3Icon from "./icons/PlasmicIcon__Icon3"; // plasmic-import: moTnu4oq_HA-/icon
...
function PlasmicDrawer__RenderFunc(props: {
  ...
  return (
    <Dialog
      ...
      overlayClassName={classNames({ [sty["pcls_M6z9Uhukyl6_"]]: true })}
      ...
      triggerSlot={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__gnp6Z)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
    ...
    >
      ...
      >
        ...
        >
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <div className={classNames(projectcss.all, sty.freeBox___1V7Jr)}>
                <div
                  className={classNames(
                    projectcss.all,
                    projectcss.__wab_text,
