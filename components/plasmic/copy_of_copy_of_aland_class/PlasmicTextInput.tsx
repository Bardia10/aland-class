...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: Cuev8U_BJlLG/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg___0VRdm)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__hgKJp)}
              role={"img"}
            />
          ),
