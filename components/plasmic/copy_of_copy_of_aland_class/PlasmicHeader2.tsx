...
import sty from "./PlasmicHeader2.module.css"; // plasmic-import: TXgAYHWSvuIg/css

import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: ep15jNBOwX87/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: XRffJqLdEBrY/icon
...
function PlasmicHeader2__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__o342W)}>
        <div className={classNames(projectcss.all, sty.freeBox__oZzPp)}>
          <Button
          ...
          >
            {false ? (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__fTWfX)}
                role={"img"}
              />
            ) : null}
            <div
            ...
            {false ? (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__tlike)}
                role={"img"}
              />
            ) : null}
          </PlasmicLink__>
          ...
          >
            {false ? (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__g27Dv)}
                role={"img"}
              />
            ) : null}
            <div
            ...
            {false ? (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__udf03)}
                role={"img"}
              />
            ) : null}
          </PlasmicLink__>
          ...
          >
            {false ? (
              <IconIcon
                className={classNames(projectcss.all, sty.svg___0K4N)}
                role={"img"}
              />
            ) : null}
            <div
            ...
            {false ? (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__kk7Us)}
                role={"img"}
              />
            ) : null}
          </PlasmicLink__>
          ...
          >
            {false ? (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__coKeB)}
                role={"img"}
              />
            ) : null}
            <div
            ...
            {false ? (
              <IconIcon
                className={classNames(projectcss.all, sty.svg___26SMc)}
                role={"img"}
              />
            ) : null}
          </PlasmicLink__>
          ...
          >
            {false ? (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__aTiA1)}
                role={"img"}
              />
            ) : null}
            <div
            ...
            {false ? (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__oaYk7)}
                role={"img"}
              />
            ) : null}
          </PlasmicLink__>
